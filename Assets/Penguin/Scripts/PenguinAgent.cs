...
using UnityEngine;
using MLAgents;
// Set class definition to inherit from Agent instead of Monobehaviour
public class PenguinAgent : Agent
{
    // Public variables to keep track
    ...
    public override void AgentAction(float[] vectorAction)
    {
        ...
        //AddReward(-1f / agentParameters.maxStep); ML-Agents-0.13.0 <
